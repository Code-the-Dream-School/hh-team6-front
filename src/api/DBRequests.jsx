...
export const saveBook = async (isbn10, isbn13, token) => {
  const data = { isbn10, isbn13 };
  await handleApiRequest(`/api/v1/saved-books/`, { headers: {} }, data, token);
};
...
export const getCart = async (setCartItems, setTotals, token) => {
  const {
    data: { cart },
  } = await handleApiRequest(
    '/api/v1/cart',
...
export const deleteFromCart = (cartItemId, token) => {
